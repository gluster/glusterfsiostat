        ...
        this.DrawAxes = function ()
        {
            ...
            co.beginPath();
                ...
                if (   prop['chart.noxtickmarks'] == false
                    ...
                    var i = prop['chart.yaxispos'] === 'center' ? 5 : 10; while(i--) {
                        var gap = (ca.width - this.gutterRight - this.gutterLeft) / 10
                        var x   = ca.width - this.gutterRight - (i * gap);
